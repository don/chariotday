...
void setup() {
  ...
  // Use the serial number of the ECCx08 chip as the clientId
  // The certificate must use the serial number as the common name
...
void sendSensorData() {
  ...
  // AWS prefers JSON payload for MQTT
